...
// and stores ciphertexts in HKCU\Software\Greylock.okens, keyed by
// the 'key' argument passed to put/get/remove.
//
// Behavior is identical to the v0.1 SecurityService: per-user DPAPI binding,
// CRYPTPROTECT_UI_FORBIDDEN flag, registry path Software\Greylock.okens.
...
private:
    static constexpr const char* kRegistrySubkey = "Software\\Greylock.Tokens";
};
